                    ...
                    contenido de arraypacientes con la key paciente -->
                           <tr v-for="paciente in arrayPacientes" :key="paciente.id">   
                               <td><!-- se agrega la directiva @click en el boton y el valor de objeto no lleva comillas -->
                                   <button type="button" @click="abrirModal('paciente','actualizar',paciente)" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="right" title="Click para actualizar datos">
                                     <i class="icon-user"></i>&nbsp;Actualizar
                                   </button> &nbsp;
                                   <button type="button" @click="abrirModal('paciente','actualizar',paciente)" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="right" title="Asignar solicitud de laboratorio">
       ...
       <!--Fin del modal-->
                        ...
                        <div class="modal-dialog modal-primary modal-lg">
                            ...
                            <form action="" method="post">
                                <div class="modal-body">
                                <select class="select" multiple data-mdb-container="#exampleModal" data-mdb-filter="true">
